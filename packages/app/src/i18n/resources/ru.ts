...
export const ru: TranslationResources = {
  ...
  agentStream: {
    ...
    activity: { thinking: "Размышляет", waiting: "Ожидает" },
    permission: {
      plan: "План",
  ...
  settings: {
    ...
    general: {
      ...
      defaultSend: {
        ...
        descriptions: {
          interrupt:
            "Enter добавляет новую строку. Основное действие и Command/Ctrl+Enter прерывают текущий ход; Tab ставит сообщение в очередь.",
          steer:
            "Enter добавляет новую строку. Основное действие и Command/Ctrl+Enter направляют текущий ход; Tab ставит сообщение в очередь.",
          queue:
            "Enter добавляет новую строку. Основное действие и Tab ставят сообщение в очередь; Command/Ctrl+Enter прерывает текущий ход.",
        },
        options: {
          interrupt: "Прерывать",
          steer: "Направить",
