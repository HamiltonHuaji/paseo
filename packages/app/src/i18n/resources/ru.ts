  ...
  settings: {
    ...
    host: {
      ...
      pairDevices: {
        ...
        offlineHint: "Подключитесь к этому хосту, чтобы поделиться ссылкой для сопряжения",
        updateHostHint: "Обновите этот хост, чтобы поделиться ссылкой для сопряжения",
      },
      orchestration: {
        title: "оркестровка",
