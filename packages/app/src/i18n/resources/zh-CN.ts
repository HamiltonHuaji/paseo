...
export const zhCN: TranslationResources = {
  ...
  agentStream: {
    ...
    activity: { thinking: "正在思考", waiting: "正在等待" },
    permission: {
      plan: "Plan",
      required: "需要权限",
      deny: "拒绝",
  ...
  message: {
    ...
    actions: {
      ...
      copyMessage: "复制消息",
      forkMenu: "分叉消息",
      forkImplementationNative: "原生会话分叉",
      forkImplementationCopiedContext: "复制聊天历史",
      forkInNewTab: "分叉到新标签页",
      forkInNewWorkspace: "分叉到新工作区",
      forkUnavailable: "请更新主机以使用此功能。",
      forkNativeUnavailable: "请同时更新 Paseo 客户端和主机，以原生分叉 Codex 会话。",
      forkWaitForTurn: "请等待当前 turn 完成后再分叉。",
      forkSameHost: "Codex 原生分叉必须在源主机上创建。",
  ...
  desktop: {
    ...
    updates: {
      ...
      official: { switchFailed: "无法切换到 Paseo 官方版本。" },
      callout: {
    ...
    about: {
      ...
      updates: {
        ...
        official: {
          ...
          switchMessage:
            "这会停止正在运行的 Agent 和终端会话，然后用官方版本替换此 Fork。若要返回 Fork，需要从 HamiltonHuaji/paseo Releases 手动安装。",
          switchConfirm: "切换到官方版本",
        },
      },
    },
    appearance: {
